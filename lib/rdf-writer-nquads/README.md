# RDF.rs Writer: rdf-writer-nquads

[![License](https://img.shields.io/badge/license-Public%20Domain-blue.svg)](https://unlicense.org)
[![Compatibility](https://img.shields.io/badge/rust-1.85%2B-blue)](https://blog.rust-lang.org/2025/02/20/Rust-1.85.0/)
[![Package](https://img.shields.io/crates/v/rdf-writer-nquads)](https://crates.io/crates/rdf-writer-nquads)
[![Documentation](https://docs.rs/rdf-writer-nquads/badge.svg)](https://docs.rs/rdf-writer-nquads)
...
```toml
[dependencies]
rdf-writer-nquads = { version = "0.4", default-features = false, features = ["serde"] }
```
...
```rust
use rdf_writer_nquads::*;
```

## 📚 Reference

[docs.rs/rdf-writer-nquads](https://docs.rs/rdf-writer-nquads)
...
[feature flags]: https://github.com/rust-rdf/rdf.rs/blob/master/lib/rdf-writer-nquads/Cargo.toml
