...
[![Package](https://img.shields.io/crates/v/rdf-writer-jelly)](https://crates.io/crates/rdf-writer-jelly)
[![Documentation](https://docs.rs/rdf-writer-jelly/badge.svg)](https://docs.rs/rdf-writer-jelly)

A Jelly file writer for [RDF.rs] knowledge graphs.
...
```toml
[dependencies]
rdf-writer-jelly = { version = "0.4", default-features = false, features = ["serde"] }
```
...
[docs.rs/rdf-writer-jelly](https://docs.rs/rdf-writer-jelly)
...
[feature flags]: https://github.com/rust-rdf/rdf.rs/blob/master/lib/rdf-writer-jelly/Cargo.toml
