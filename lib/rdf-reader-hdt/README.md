# RDF.rs Reader: rdf-reader-hdt

[![License](https://img.shields.io/badge/license-Public%20Domain-blue.svg)](https://unlicense.org)
[![Compatibility](https://img.shields.io/badge/rust-1.85%2B-blue)](https://blog.rust-lang.org/2025/02/20/Rust-1.85.0/)
[![Package](https://img.shields.io/crates/v/rdf-reader-hdt)](https://crates.io/crates/rdf-reader-hdt)
[![Documentation](https://docs.rs/rdf-reader-hdt/badge.svg)](https://docs.rs/rdf-reader-hdt)
...
```toml
[dependencies]
rdf-reader-hdt = { version = "0.4", default-features = false, features = ["serde"] }
```
...
[docs.rs/rdf-reader-hdt](https://docs.rs/rdf-reader-hdt)
...
[feature flags]: https://github.com/rust-rdf/rdf.rs/blob/master/lib/rdf-reader-hdt/Cargo.toml
