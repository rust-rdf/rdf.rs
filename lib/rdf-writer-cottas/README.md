# RDF.rs Writer: COTTAS

[![License](https://img.shields.io/badge/license-Public%20Domain-blue.svg)](https://unlicense.org)
[![Compatibility](https://img.shields.io/badge/rust-1.85%2B-blue)](https://blog.rust-lang.org/2025/02/20/Rust-1.85.0/)
[![Package](https://img.shields.io/crates/v/rdf-writer-cottas)](https://crates.io/crates/rdf-writer-cottas)
[![Documentation](https://docs.rs/rdf-writer-cottas/badge.svg)](https://docs.rs/rdf-writer-cottas)

A COTTAS file writer for [RDF.rs] knowledge graphs.
...
```toml
[dependencies]
rdf-writer-cottas = { version = "0.4", default-features = false, features = ["serde"] }
```
...
[docs.rs/rdf-writer-cottas](https://docs.rs/rdf-writer-cottas)
...
[feature flags]: https://github.com/rust-rdf/rdf.rs/blob/master/lib/rdf-writer-cottas/Cargo.toml
