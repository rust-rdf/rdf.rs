# RDF.rs Reader: rdf-reader-trig

[![License](https://img.shields.io/badge/license-Public%20Domain-blue.svg)](https://unlicense.org)
[![Compatibility](https://img.shields.io/badge/rust-1.85%2B-blue)](https://blog.rust-lang.org/2025/02/20/Rust-1.85.0/)
[![Package](https://img.shields.io/crates/v/rdf-reader-trig)](https://crates.io/crates/rdf-reader-trig)
[![Documentation](https://docs.rs/rdf-reader-trig/badge.svg)](https://docs.rs/rdf-reader-trig)
...
```toml
[dependencies]
rdf-reader-trig = { version = "0.4", default-features = false, features = ["serde"] }
```
...
[docs.rs/rdf-reader-trig](https://docs.rs/rdf-reader-trig)
...
[feature flags]: https://github.com/rust-rdf/rdf.rs/blob/master/lib/rdf-reader-trig/Cargo.toml
