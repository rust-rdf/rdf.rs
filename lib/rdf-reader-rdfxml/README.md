# RDF.rs Reader: RDF/XML

[![License](https://img.shields.io/badge/license-Public%20Domain-blue.svg)](https://unlicense.org)
[![Compatibility](https://img.shields.io/badge/rust-1.85%2B-blue)](https://blog.rust-lang.org/2025/02/20/Rust-1.85.0/)
[![Package](https://img.shields.io/crates/v/rdf-reader-rdfxml)](https://crates.io/crates/rdf-reader-rdfxml)
[![Documentation](https://docs.rs/rdf-reader-rdfxml/badge.svg)](https://docs.rs/rdf-reader-rdfxml)
...
```toml
[dependencies]
rdf-reader-rdfxml = { version = "0.4", default-features = false, features = ["serde"] }
```
...
[docs.rs/rdf-reader-rdfxml](https://docs.rs/rdf-reader-rdfxml)
...
[feature flags]: https://github.com/rust-rdf/rdf.rs/blob/master/lib/rdf-reader-rdfxml/Cargo.toml
