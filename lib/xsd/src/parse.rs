...
pub fn parse(input: impl AsRef<str>, datatype: impl Into<Type>) -> Result<Value, ()> {
    ...
    match datatype.into() {
        ...
        Primitive(P::String) => parse_string(input).map_err(|_| ()),
...
pub fn parse_decimal(input: impl AsRef<str>) -> Result<Value, ()> {
    input.as_ref().parse::<Decimal>().map(Value::from)
}

pub fn parse_integer(input: impl AsRef<str>) -> Result<Value, ()> {
    input
        .as_ref()
        .parse::<Integer>()
...
pub fn parse_long(input: impl AsRef<str>) -> Result<Value, ()> {
    input
        .as_ref()
        .parse::<Long>()
        .map(DecimalValue::from)
...
pub fn parse_int(input: impl AsRef<str>) -> Result<Value, ()> {
    input
        .as_ref()
        .parse::<Int>()
        .map(DecimalValue::from)
...
pub fn parse_short(input: impl AsRef<str>) -> Result<Value, ()> {
    input
        .as_ref()
        .parse::<Short>()
        .map(DecimalValue::from)
...
pub fn parse_byte(input: impl AsRef<str>) -> Result<Value, ()> {
    input
        .as_ref()
        .parse::<Byte>()
        .map(DecimalValue::from)
...
pub fn parse_boolean(input: impl AsRef<str>) -> Result<Value, ()> {
    input.as_ref().parse::<Boolean>().map(Value::from)
}

pub fn parse_float(input: impl AsRef<str>) -> Result<Value, ()> {
    input.as_ref().parse::<Float>().map(Value::from)
}

pub fn parse_double(input: impl AsRef<str>) -> Result<Value, ()> {
    input.as_ref().parse::<Double>().map(Value::from)
}

#[cfg(feature = "jiff")]
pub fn parse_duration(input: impl AsRef<str>) -> Result<Value, ()> {
    input
        .as_ref()
        .parse::<Duration>()
        .map(Value::from)
...
#[cfg(feature = "jiff")]
pub fn parse_datetime(input: impl AsRef<str>) -> Result<Value, ()> {
    input
        .as_ref()
        .parse::<DateTime>()
        .map(Value::from)
...
#[cfg(feature = "jiff")]
pub fn parse_time(input: impl AsRef<str>) -> Result<Value, ()> {
    input
        .as_ref()
        .parse::<Time>()
        .map(Value::from)
...
#[cfg(feature = "jiff")]
pub fn parse_date(input: impl AsRef<str>) -> Result<Value, ()> {
    input
        .as_ref()
        .parse::<Date>()
        .map(Value::from)
