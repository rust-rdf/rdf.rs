# RDF.rs Writer: rdf-writer-jsonld

[![License](https://img.shields.io/badge/license-Public%20Domain-blue.svg)](https://unlicense.org)
[![Compatibility](https://img.shields.io/badge/rust-1.85%2B-blue)](https://blog.rust-lang.org/2025/02/20/Rust-1.85.0/)
[![Package](https://img.shields.io/crates/v/rdf-writer-jsonld)](https://crates.io/crates/rdf-writer-jsonld)
[![Documentation](https://docs.rs/rdf-writer-jsonld/badge.svg)](https://docs.rs/rdf-writer-jsonld)
...
```toml
[dependencies]
rdf-writer-jsonld = { version = "0.4", default-features = false, features = ["serde"] }
```
...
[docs.rs/rdf-writer-jsonld](https://docs.rs/rdf-writer-jsonld)
...
[feature flags]: https://github.com/rust-rdf/rdf.rs/blob/master/lib/rdf-writer-jsonld/Cargo.toml
