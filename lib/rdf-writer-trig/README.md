# RDF.rs Writer: rdf-writer-trig

[![License](https://img.shields.io/badge/license-Public%20Domain-blue.svg)](https://unlicense.org)
[![Compatibility](https://img.shields.io/badge/rust-1.85%2B-blue)](https://blog.rust-lang.org/2025/02/20/Rust-1.85.0/)
[![Package](https://img.shields.io/crates/v/rdf-writer-trig)](https://crates.io/crates/rdf-writer-trig)
[![Documentation](https://docs.rs/rdf-writer-trig/badge.svg)](https://docs.rs/rdf-writer-trig)
...
```toml
[dependencies]
rdf-writer-trig = { version = "0.4", default-features = false, features = ["serde"] }
```
...
[docs.rs/rdf-writer-trig](https://docs.rs/rdf-writer-trig)
...
[feature flags]: https://github.com/rust-rdf/rdf.rs/blob/master/lib/rdf-writer-trig/Cargo.toml
