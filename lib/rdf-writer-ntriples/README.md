# RDF.rs Writer: N-Triples

[![License](https://img.shields.io/badge/license-Public%20Domain-blue.svg)](https://unlicense.org)
[![Compatibility](https://img.shields.io/badge/rust-1.85%2B-blue)](https://blog.rust-lang.org/2025/02/20/Rust-1.85.0/)
[![Package](https://img.shields.io/crates/v/rdf-writer-ntriples)](https://crates.io/crates/rdf-writer-ntriples)
[![Documentation](https://docs.rs/rdf-writer-ntriples/badge.svg)](https://docs.rs/rdf-writer-ntriples)
...
```toml
[dependencies]
rdf-writer-ntriples = { version = "0.4" }
```
...
```toml
[dependencies]
rdf-writer-ntriples = { version = "0.4", default-features = false, features = ["serde"] }
```
...
[docs.rs/rdf-writer-ntriples](https://docs.rs/rdf-writer-ntriples)
...
[feature flags]: https://github.com/rust-rdf/rdf.rs/blob/master/lib/rdf-writer-ntriples/Cargo.toml
