# RDF.rs Reader: rdf-reader-ntriples

[![License](https://img.shields.io/badge/license-Public%20Domain-blue.svg)](https://unlicense.org)
[![Compatibility](https://img.shields.io/badge/rust-1.85%2B-blue)](https://blog.rust-lang.org/2025/02/20/Rust-1.85.0/)
[![Package](https://img.shields.io/crates/v/rdf-reader-ntriples)](https://crates.io/crates/rdf-reader-ntriples)
[![Documentation](https://docs.rs/rdf-reader-ntriples/badge.svg)](https://docs.rs/rdf-reader-ntriples)
...
```toml
[dependencies]
rdf-reader-ntriples = { version = "0.4" }
```
...
```toml
[dependencies]
rdf-reader-ntriples = { version = "0.4", default-features = false, features = ["serde"] }
```
...
```rust
use rdf_reader_ntriples::*;
```

## 📚 Reference

[docs.rs/rdf-reader-ntriples](https://docs.rs/rdf-reader-ntriples)
...
[feature flags]: https://github.com/rust-rdf/rdf.rs/blob/master/lib/rdf-reader-ntriples/Cargo.toml
