...
```toml
[dependencies]
rdf-reader-jelly = { version = "0.4", default-features = false, features = ["serde"] }
```
...
[docs.rs/rdf-reader-jelly](https://docs.rs/rdf-reader-jelly)
...
[feature flags]: https://github.com/rust-rdf/rdf.rs/blob/master/lib/rdf-reader-jelly/Cargo.toml
