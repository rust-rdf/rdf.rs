...
```toml
[dependencies]
rdf-writer-hdt = { version = "0.4", default-features = false, features = ["serde"] }
```
...
[docs.rs/rdf-writer-hdt](https://docs.rs/rdf-writer-hdt)
...
[feature flags]: https://github.com/rust-rdf/rdf.rs/blob/master/lib/rdf-writer-hdt/Cargo.toml
